...
- If a team is guaranteed at least third but not yet guaranteed to qualify through best-third ranking, show the intermediate `לפחות מקום 3` badge instead of `הבטיחה העפלה`.
