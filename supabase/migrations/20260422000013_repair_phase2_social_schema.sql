-- ============================================================
-- Manual-safe repair for Phase 2 social schema
-- Use this when an earlier draft created or attempted to create
-- tournament_predictions.predicted_winner_team_id as BIGINT.
-- ============================================================
...
begin
  if exists (
    ...
    alter table public.tournament_predictions
      add column predicted_winner_team_id uuid;
  end if;
