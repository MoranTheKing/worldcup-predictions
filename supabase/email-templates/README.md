...
אם משתמש אומר שלא הגיע קוד, לבדוק קודם האם הכתובת כבר קיימת ומאומתת ב-Supabase Auth.
במקרה כזה Supabase עשוי להחזיר תשובת signup ללא שגיאת Auth מובהקת, אבל לא אמור להישלח קוד הרשמה חדש.

התנהגות האפליקציה אחרי תיקון 2026-04-24:

- כתובת חדשה עוברת למסך הזנת קוד.
- כתובת שכבר לא יכולה לפתוח הרשמה חדשה מקבלת הודעה להתחבר במקום או להשתמש בכתובת אחרת.
- כפתור "שלח קוד חדש" מועיל רק לכתובת שעדיין ממתינה לאימות; לכתובת שכבר נרשמה צריך להתחבר.
