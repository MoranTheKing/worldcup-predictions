    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
        <div className="text-center max-w-sm">
          ...
          <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 mb-2">בדוק את האימייל שלך</h2>
          <p className="text-sm text-zinc-500">שלחנו לך קישור אימות ל-{email}. לאחר אישור תוכל להתחבר.</p>
          <Link href="/login" className="inline-block mt-6 text-sm font-medium text-zinc-900 dark:text-zinc-50 underline underline-offset-2">
            חזרה לדף ההתחברות
          </Link>
        </div>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">הרשמה</h1>
        ...
        <p className="text-center text-sm text-zinc-500 mt-4">
          יש לך חשבון?{" "}
          <Link href="/login" className="font-medium text-zinc-900 dark:text-zinc-50 underline underline-offset-2">
            התחברות
          </Link>
        </p>
      </div>
