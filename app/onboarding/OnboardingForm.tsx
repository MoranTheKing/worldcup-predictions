      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-wc-fg2">
            {tournamentStarted
              ? "עוד רגע נכנסים. קודם מאשרים כינוי ייחודי ותמונה אם בא לך; ניחושי הזוכה ומלך השערים כבר נעולים כי הטורניר התחיל."
              : "עוד רגע נכנסים. קודם בוחרים כינוי ייחודי, תמונה אם בא לך, ואת ניחושי הפתיחה שלך לטורניר."}
          </p>
        </div>
