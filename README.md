...
- Dev Tools מונע מצבי משחק לא עקביים: במחצית ובפנדלים אין שדה דקה פעיל, הארכה/פנדלים זמינים רק בנוקאאוט, וכפתור השמירה נשאר גלוי גם בגלילה אופקית.
- `/mfa/setup` כבר לא מאפשר למשתמש שכבר סיים הרשמה ופרופיל להתחיל חיבור Authenticator חדש בטעות; הוא פתוח רק בזמן הרשמה/השלמת MFA או כשיש factor לא מאומת שממתין לסיום.
