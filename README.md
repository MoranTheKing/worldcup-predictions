...
- Dev Tools מונע מצבי משחק לא עקביים: במחצית ובפנדלים אין שדה דקה פעיל, הארכה/פנדלים זמינים רק בנוקאאוט, וכפתורי סטטוס/מצב/דקה/שמירה נמצאים בתחילת הטבלה כדי שלא יצטרכו לגרור שמאלה בשביל הפעולות המרכזיות.
