...
- דף בית ציבורי בעברית עבור `cup26picks.com` עם הודעת “בקרוב”.
...
- דף הבית הציבורי הוא דף “בקרוב”; אזור המשחק עדיין נגיש דרך `/game`, `/login` ו-`/signup`.
