...
- `/game/predictions` shows the available reward for home/draw/away before saving, including separate direction and exact-score totals from the knockout matrix.
